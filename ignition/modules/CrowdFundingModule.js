...
module.exports = buildModule("CrowdFunding", (m) => {
  ...
  // The minContribution is set to 0.1 ETH, the goal is set to 10 ETH, and the duration is set to 7 days.
  const crowdFundingModule = m.contract("CrowdFunding", [BigInt(ethers.parseEther("0.1")), BigInt(ethers.parseEther("10")), (7 * 24 * 60 * 60)]);
